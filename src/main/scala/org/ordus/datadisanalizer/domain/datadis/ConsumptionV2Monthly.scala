 ...
 */
case class ConsumptionV2Monthly(cups: String, date: String, consumptionKWh: Double, energyPoured: Double,
 ...
 */
case class ConsumptionV2MonthlyResponse(timeCurveList: List[ConsumptionV2Monthly], mediumCurveList: Option[String], mediumCurveAutoList: Option[String],
...
case class ConsumptionV2MonthlyResponseWrapper(response: ConsumptionV2MonthlyResponse)